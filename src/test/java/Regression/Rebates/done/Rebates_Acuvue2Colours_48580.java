 ...
 */
public class Rebates_Acuvue2Colours_48580 extends ContactsTestBase {

    //change the Strings below to change the tests
    String testNumber = "48580Acuvue2Colors";
    String orderNumberPlaceholder = "48580Acuvue2Colors_rebate";
    ...
    String brandVerifyPDP = "Acuvue 2 Colors";
    String posR = "";
    String posL = "+";
    String rPower = "-0.50";
    String lPower = "2.25";
