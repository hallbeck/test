 ...
 */
public class iniNotAllUsed extends ContactsTestBase {

    //change the Strings below to change the tests
    String testNumber = "NEEDTESTCASE";
    String typeOfTest = "Regression | Totals";
    ...
    String priceREye = "";
    String priceLEye = "47.99";
    String pricePerBox2 = "";
    String priceREye2 = "";
    String priceLEye2 = "";
    String priceTotal = "54.98";
