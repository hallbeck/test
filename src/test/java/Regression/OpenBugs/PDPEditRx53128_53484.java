 ...
 */
public class PDPEditRx53128_53484 extends ContactsTestBase {


    String testNumber = "53484";
    String typeOfTest = "Regression";
    String typeOfCust = "NI";
    String typeOfPayment = "Credit";
    String searchAllBrand = "Air Optix Night & Day Aqua";
    String searchAllBrand2 = "";
    String brandToClickOn = "Acuvue";
    String brandToClickOn2 = "";
    String brandVerifyPDP = "Air Optix Night & Day Aqua";
    ...
    public void test(String device) {
        ...
        gotoPage(device,"lens/Air-Optix-Night-Day-Aqua");
