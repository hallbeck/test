 ...
 */
public class Rebates_ClearSightDay30Pk_48580 extends TestBase {
    ...
    String RebateTextRS = "Clearsight Rebate";
...
String password = "password";
    ...
    String rsShipping = "14.99" ;    String shippingVerify = "Rebates";
