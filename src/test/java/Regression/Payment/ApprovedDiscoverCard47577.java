 ...
 */
public class ApprovedDiscoverCard47577 extends ContactsTestBase {

    //change the Strings below to change the tests
    String testNumber = "47577_DISC";
    String typeOfTest = "Verification";
String typeOfCust = "NI";
    String typeOfPayment = "Credit Discover Approved";
    ...
    String drName = "test";
    String drState = "UT";
    String creditCard = "testDiscover";
    String ccName = "Blah";
    String ccExpMo = "06";
