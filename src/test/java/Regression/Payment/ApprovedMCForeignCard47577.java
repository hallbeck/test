 ...
 */
public class ApprovedMCForeignCard47577 extends ContactsTestBase {

    //change the Strings below to change the tests
    String testNumber = "47577_MC";
    String typeOfTest = "Verification";
String typeOfCust = "NI";
    String typeOfPayment = "Credit MC Foreign Approved";
    ...
    String drName = "test";
    String drState = "UT";
    String creditCard = "testMCForeign";
    String ccName = "Blah";
    String ccExpMo = "06";
