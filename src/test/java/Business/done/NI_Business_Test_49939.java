 ...
 */
public class NI_Business_Test_49939 extends ContactsTestBase {


    //change the Strings below to change the tests
    String testNumber = "49939";
    String typeOfTest = "BUSINESS";
    String typeOfCust = "NI";
    String typeOfPayment = "Credit";
    String searchAllBrand = "Dailies Aqua Comfort Plus";
    String searchAllBrand2 = "";
    String brandToClickOn = "DailiesAquaComfortPlus";
    String brandToClickOn2 = "";
    String brandVerifyPDP = "Dailies AquaComfort Plus";
    ...
    String rsTax = "24.65";
    String rsRebate = "25 DAILIES Rebate";
