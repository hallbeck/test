 ...
 */
public class ApprovedVisaForeignCard47577 extends ContactsTestBase {

    //change the Strings below to change the tests
    String testNumber = "47577_VISA";
    String typeOfTest = "Verification";
String typeOfCust = "NI";
    String typeOfPayment = "Credit Visa Foreign Approved";
    ...
    String rsTotal = "341.83";
    String rsTotalAfterRebate = "147.92";
    String rsTax = "21.91";
    String rsRebate = "40 Acuvue Rebate";
