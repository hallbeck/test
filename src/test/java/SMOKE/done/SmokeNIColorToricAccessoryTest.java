 ...
 */
public class SmokeNIColorToricAccessoryTest extends ContactsTestBase {


    //change the Strings below to change the tests
    String testNumber = "48926";
    ...
    //String FullPatientName = (PatientFNameCart + " " + PatientLNameCart);
    String pricePerBox = "12.99";
    String priceREye = "319.96";
    String priceLEye = "159.98";
    String pricePerBox2 = "";
    String priceREye2 = "";
    String priceLEye2 = "";
    String priceTotal = "492.93";
    String rsTotal = "526.70";
    String rsTotalAfterRebate = "496.70";
    String rsTax = "33.77";
    ...
    pickCreditCardExpDate(device,ccExpMo, ccExpYear,paymentType);
        ...
        verifyRS(device,brandVerifyPDP2, PatientFNameCart, pricePerBox, priceREye, priceLEye, priceTotal, rsTax, rsTotal, rsTotalAfterRebate, rsRebate, rsShipping);
