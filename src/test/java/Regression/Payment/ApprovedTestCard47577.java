 ...
 */
public class ApprovedTestCard47577 extends ContactsTestBase {

    //change the Strings below to change the tests
    String testNumber = "47577_Test_Card";
    String typeOfTest = "Verification";
String typeOfCust = "NI";
    String typeOfPayment = "Credit Test Card";
    ...
    String orderStatus = "Test Order to be Deleted";
