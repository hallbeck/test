...
public class Rebates_sqltest_48580 extends ContactsTestBase {
    ...
    public void rebatesTest(String device,String prod) {
        ...
        checkoutAndVerify(orderNumberPlaceholder,device,shippingVerify,brandVerifyPDP,fullPatientName,rsShipping,zip,city,rsTax,rsTotal,rsRebate,rsTotalAfterRebate,orderStatus,bState,bCity);
