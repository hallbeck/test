 ...
 */
public class SmokeNIProgressiveAccessoryInternationalTest extends ContactsTestBase {
...
String typeOfCust = "NI";
    ...
    String reg = "®";
    String brandToClickOn2 = "OPTI-FREERepleniSHSolution2pack2-10oz";
    String brandVerifyPDP = "Focus DAILIES Progressives 30 pack";
    String brandVerifyPDP2 = "RepleniSH";
    String posR = "+";
    String posL = "+";
    String rPower = "0.25";
    String lPower = "0.75";
