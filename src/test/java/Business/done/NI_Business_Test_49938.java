 ...
 */
public class NI_Business_Test_49938 extends ContactsTestBase {


    //change the Strings below to change the tests
    String testNumber = "49938";
    String typeOfTest = "SMOKE";
    String typeOfCust = "NI";
    String typeOfPayment = "Credit";
    String searchAllBrand = "Air Optix Aqua Multifocal";
    String searchAllBrand2 = "";
    String brandToClickOn = "AirOptixAquaMultifocal";
    ...
    String rsTax = "32.88";
    String rsRebate = "60 Air Optix Rebate";
